...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.6\textwidth]{figures/Casing/Parameters.PNG}
    \caption{User defined parameters in Fusion 360, shown are the parameters that are mostly constraints from other aspects of the micromouse design and the casing design is built upon these accordingly}
\end{figure}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.6\textwidth]{figures/Casing/PrintedFullRight.jpg}
    \caption{Prints of base casing and cover assembled together, slightly rough around the edges, post processing will fix that}
\end{figure}
