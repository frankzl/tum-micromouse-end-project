...
\textcolor{red}{Could you please drop the "noindent" thingy? In all other sections paragraphs start with indent and this will look a bit inconsistent}
...
Adam: I think we don't need to talk more about decisions here. The analysis done is sufficient and the hardware part does explain a lot of stuff.}
