...
>>>>>>> 6c09a0bb8ac4424f106a6eee044ef8266b4d1c80
\begin{figure}[htb]
    \centering
...
%I would propose we don't lie at all. Since there was never a Gantt chart, we shouldn't make up one.
% What happened: 1) We started with gaining theoretical knowledge of electronics and an MCU, also producing some modules code.
                 2) Right after Christmas we started designing the PCB and transfering our existing code to the new MCU.
                 3) At the moment, we have some working code, no PCB and no components yet.
...
Include state machine model and PID controller.
...
%I would keep the personal sharing part to a minimum. Rather merge this with Propositions and Learning outcomes.
