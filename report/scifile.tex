...
\title{Micromouse Report \\
\large Designing an Educational Racing-Robot from Scratch \\-\\
...
% \author
% {Adam Pasvatis$^{1}$, Frank Lu$^{2}$, Meryem Guemimi$^{3}$, Natalia Poliakova$^{4}$, René Lalla$^{5}$, Sihong Chen$^{6}$\\
% \\
...
\begin{sciabstract}
  \section*{Abstract}
    ...
    All the code to the project can be found on GitHub in the project called \href{https://github.com/frankzl/tum-micromouse-end-project}{``tum-micromouse-end-project''}
...
\begin{itemize}
    ...
    \item Frank and Meryem (50 : 50)\\
        Code for the old microcontroller, initial software configuration (pin mapping, GPIO, configuration bits), peripheral configuration: timer, ADC, DMA, motor driving functions, PID controller: implementation of a cascade controller. (all the software part for the new microcontroller)
    \item Natalia\\
