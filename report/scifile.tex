...
\normalsize{$^{2}$Department of Informatics, Technical University of Munich}\\
\normalsize{$^{3}$Another Unknown Address}\\
\normalsize{$^{4}$Department of Informatics, Technical University of Munich}\\
